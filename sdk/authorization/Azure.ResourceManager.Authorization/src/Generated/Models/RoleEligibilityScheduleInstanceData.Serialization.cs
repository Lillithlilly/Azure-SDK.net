...
namespace Azure.ResourceManager.Authorization
{
    public partial class RoleEligibilityScheduleInstanceData
    {
        internal static RoleEligibilityScheduleInstanceData DeserializeRoleEligibilityScheduleInstanceData(JsonElement element)
        {
            ...
            return new RoleEligibilityScheduleInstanceData(id, name, type, scope.Value, roleDefinitionId.Value, principalId.Value, Optional.ToNullable(principalType), roleEligibilityScheduleId.Value, Optional.ToNullable(status), Optional.ToNullable(startDateTime), Optional.ToNullable(endDateTime), Optional.ToNullable(memberType), condition.Value, conditionVersion.Value, Optional.ToNullable(createdOn), expandedProperties.Value);
        }
    }
}
