...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleManagementPolicyNotificationRule : RoleManagementPolicyRule
    {
        ...
        /// <param name="notificationRecipients"> The list notification recipients. </param>
        /// <param name="isDefaultRecipientsEnabled"> Its value determine if the notification need to be sent to the recipient type specified in policy rule. </param>
        ...
        /// <summary> Its value determine if the notification need to be sent to the recipient type specified in policy rule. </summary>
