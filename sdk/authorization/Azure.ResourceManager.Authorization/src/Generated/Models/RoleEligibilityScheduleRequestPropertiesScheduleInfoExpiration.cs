...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class RoleEligibilityScheduleRequestPropertiesScheduleInfoExpiration
    {
        ...
        /// <param name="endDateTime"> End DateTime of the role eligibility schedule. </param>
        /// <param name="duration"> Duration of the role eligibility schedule in TimeSpan. </param>
        internal RoleEligibilityScheduleRequestPropertiesScheduleInfoExpiration(Type? type, DateTimeOffset? endDateTime, string duration)
        {
            Type = type;
