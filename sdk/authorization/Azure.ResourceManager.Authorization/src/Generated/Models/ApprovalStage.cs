...
namespace Azure.ResourceManager.Authorization.Models
{
    ...
    public partial class ApprovalStage
    {
        ...
        /// <param name="isApproverJustificationRequired"> Determine whether approver need to provide justification for his decision. </param>
        /// <param name="escalationTimeInMinutes"> The time in minutes when the approval request would be escalated if the primary approver does not approves. </param>
        ...
        /// <summary> The time in minutes when the approval request would be escalated if the primary approver does not approves. </summary>
