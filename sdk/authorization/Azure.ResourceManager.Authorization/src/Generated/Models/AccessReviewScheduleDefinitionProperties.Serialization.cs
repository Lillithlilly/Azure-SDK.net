...
{
    public partial class AccessReviewScheduleDefinitionProperties : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName("descriptionForAdmins");
                writer.WriteStringValue(DescriptionForAdmins);
            }
            if (Optional.IsDefined(DescriptionForReviewers))
            {
                writer.WritePropertyName("descriptionForReviewers");
            ...
            writer.WriteStartObject();
            if (Optional.IsDefined(TypeSettingsRecurrenceRangeType))
            {
                writer.WritePropertyName("type");
                writer.WriteStringValue(TypeSettingsRecurrenceRangeType.Value.ToString());
            }
            ...
            writer.WriteStartObject();
            if (Optional.IsDefined(TypeSettingsRecurrencePatternType))
            {
                writer.WritePropertyName("type");
                writer.WriteStringValue(TypeSettingsRecurrencePatternType.Value.ToString());
            }
