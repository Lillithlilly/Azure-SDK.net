...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class RoleManagementPolicyData : Resource
    {
        ...
        internal RoleManagementPolicyData(ResourceIdentifier id, string name, ResourceType type, string scope, string displayName, string description, bool? isOrganizationDefault, Principal lastModifiedBy, DateTimeOffset? lastModifiedDateTime, IList<RoleManagementPolicyRule> rules, IReadOnlyList<RoleManagementPolicyRule> effectiveRules, PolicyProperties policyProperties) : base(id, name, type)
        {
            Scope = scope;
