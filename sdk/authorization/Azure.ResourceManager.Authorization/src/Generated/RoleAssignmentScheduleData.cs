...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class RoleAssignmentScheduleData : Resource
    {
        ...
        /// <param name="startDateTime"> Start DateTime when role assignment schedule. </param>
        /// <param name="endDateTime"> End DateTime when role assignment schedule. </param>
        ...
        internal RoleAssignmentScheduleData(ResourceIdentifier id, string name, ResourceType type, string scope, string roleDefinitionId, string principalId, PrincipalType? principalType, string roleAssignmentScheduleRequestId, string linkedRoleEligibilityScheduleId, AssignmentType? assignmentType, MemberType? memberType, Status? status, DateTimeOffset? startDateTime, DateTimeOffset? endDateTime, string condition, string conditionVersion, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, ExpandedProperties expandedProperties) : base(id, name, type)
        {
            Scope = scope;
