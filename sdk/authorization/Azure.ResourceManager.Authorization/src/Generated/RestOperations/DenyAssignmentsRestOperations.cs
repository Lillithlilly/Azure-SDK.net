...
namespace Azure.ResourceManager.Authorization
{
    internal partial class DenyAssignmentsRestOperations
    {
        ...
        public DenyAssignmentsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, Uri endpoint = null)
        {
        ...
        public async Task<Response<DenyAssignmentData>> GetByIdAsync(string denyAssignmentId, CancellationToken cancellationToken = default)
        {
            if (denyAssignmentId == null)
            {
                throw new ArgumentNullException(nameof(denyAssignmentId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="denyAssignmentId"/> is null. </exception>
        public Response<DenyAssignmentData> GetById(string denyAssignmentId, CancellationToken cancellationToken = default)
        {
            if (denyAssignmentId == null)
            {
                throw new ArgumentNullException(nameof(denyAssignmentId));
