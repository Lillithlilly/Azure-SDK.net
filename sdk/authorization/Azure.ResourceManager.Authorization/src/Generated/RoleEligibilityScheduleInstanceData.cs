...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class RoleEligibilityScheduleInstanceData : Resource
    {
        ...
        /// <param name="startDateTime"> The startDateTime of the role eligibility schedule instance. </param>
        /// <param name="endDateTime"> The endDateTime of the role eligibility schedule instance. </param>
        ...
        internal RoleEligibilityScheduleInstanceData(ResourceIdentifier id, string name, ResourceType type, string scope, string roleDefinitionId, string principalId, PrincipalType? principalType, string roleEligibilityScheduleId, Status? status, DateTimeOffset? startDateTime, DateTimeOffset? endDateTime, MemberType? memberType, string condition, string conditionVersion, DateTimeOffset? createdOn, ExpandedProperties expandedProperties) : base(id, name, type)
        {
            Scope = scope;
