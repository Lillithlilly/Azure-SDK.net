...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class RoleAssignmentScheduleInstanceData : Resource
    {
        ...
        /// <param name="startDateTime"> The startDateTime of the role assignment schedule instance. </param>
        /// <param name="endDateTime"> The endDateTime of the role assignment schedule instance. </param>
        ...
        internal RoleAssignmentScheduleInstanceData(ResourceIdentifier id, string name, ResourceType type, string scope, string roleDefinitionId, string principalId, PrincipalType? principalType, string roleAssignmentScheduleId, string originRoleAssignmentId, Status? status, DateTimeOffset? startDateTime, DateTimeOffset? endDateTime, string linkedRoleEligibilityScheduleId, string linkedRoleEligibilityScheduleInstanceId, AssignmentType? assignmentType, MemberType? memberType, string condition, string conditionVersion, DateTimeOffset? createdOn, ExpandedProperties expandedProperties) : base(id, name, type)
        {
            Scope = scope;
