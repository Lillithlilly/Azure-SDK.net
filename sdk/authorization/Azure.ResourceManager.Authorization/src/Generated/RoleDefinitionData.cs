...
namespace Azure.ResourceManager.Authorization
{
    ...
    public partial class RoleDefinitionData : Resource
    {
        ...
        internal RoleDefinitionData(ResourceIdentifier id, string name, ResourceType type, string roleName, string description, string roleType, IList<Permission> permissions, IList<string> assignableScopes) : base(id, name, type)
        {
            RoleName = roleName;
