...
{
    internal partial class BatchServiceRestClient
    {
        private string vaultBaseUrl;
        private ClientDiagnostics _clientDiagnostics;
        private HttpPipeline _pipeline;

        /// <summary> Initializes a new instance of BatchServiceRestClient. </summary>
        ...
        public BatchServiceRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string vaultBaseUrl)
        {
        ...
        internal HttpMessage CreateGetSecretRequest(string secretName)
        {
            ...
            uri.AppendQuery("api-version", "7.0", true);
            request.Uri = uri;
