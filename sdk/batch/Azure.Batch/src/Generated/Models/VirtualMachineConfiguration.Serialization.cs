...
namespace Azure.Batch.Models
{
    public partial class VirtualMachineConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineConfiguration DeserializeVirtualMachineConfiguration(JsonElement element)
        {
            ...
            return new VirtualMachineConfiguration(imageReference, nodeAgentSKUId, windowsConfiguration.Value, Optional.ToList(dataDisks), licenseType.Value, containerConfiguration.Value, diskEncryptionConfiguration.Value);
        }
    }
}
