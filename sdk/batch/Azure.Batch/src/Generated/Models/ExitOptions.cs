...
namespace Azure.Batch.Models
{
    ...
    public partial class ExitOptions
    {
        ...
        /// <summary> Initializes a new instance of ExitOptions. </summary>
        /// <param name="jobAction"> The default is none for exit code 0 and terminate for all other exit conditions. If the Job&apos;s onTaskFailed property is noaction, then specifying this property returns an error and the add Task request fails with an invalid property value error; if you are calling the REST API directly, the HTTP status code is 400 (Bad Request). </param>
