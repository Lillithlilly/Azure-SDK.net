...
namespace Azure.Batch.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AccountListPoolNodeCountsOptions. </summary>
        public AccountListPoolNodeCountsOptions()
        {
        }

        /// <summary> An OData $filter clause. For more information on constructing this filter, see https://docs.microsoft.com/en-us/rest/api/batchservice/odata-filters-in-batch. </summary>
