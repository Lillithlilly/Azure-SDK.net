...
namespace Azure.Batch.Models
{
    ...
    public partial class AzureBlobFileSystemConfiguration
    {
        ...
        /// <param name="accountName"> The Azure Storage Account name. </param>
        /// <param name="containerName"> The Azure Blob Storage Container name. </param>
        /// <param name="accountKey"> This property is mutually exclusive with sasKey and one must be specified. </param>
        /// <param name="sasKey"> This property is mutually exclusive with accountKey and one must be specified. </param>
        /// <param name="blobfuseOptions"> These are &apos;net use&apos; options in Windows and &apos;mount&apos; options in Linux. </param>
        /// <param name="relativeMountPath"> All file systems are mounted relative to the Batch mounts directory, accessible via the AZ_BATCH_NODE_MOUNTS_DIR environment variable. </param>
        internal AzureBlobFileSystemConfiguration(string accountName, string containerName, string accountKey, string sasKey, string blobfuseOptions, string relativeMountPath)
        {
            AccountName = accountName;
            ContainerName = containerName;
        ...
        /// <summary> This property is mutually exclusive with sasKey and one must be specified. </summary>
        public string AccountKey { get; set; }
        /// <summary> This property is mutually exclusive with accountKey and one must be specified. </summary>
