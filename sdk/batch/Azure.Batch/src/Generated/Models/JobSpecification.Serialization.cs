...
namespace Azure.Batch.Models
{
    public partial class JobSpecification : IUtf8JsonSerializable
    {
        ...
        internal static JobSpecification DeserializeJobSpecification(JsonElement element)
        {
            ...
            return new JobSpecification(Optional.ToNullable(priority), displayName.Value, Optional.ToNullable(usesTaskDependencies), Optional.ToNullable(onAllTasksComplete), Optional.ToNullable(onTaskFailure), networkConfiguration.Value, constraints.Value, jobManagerTask.Value, jobPreparationTask.Value, jobReleaseTask.Value, Optional.ToList(commonEnvironmentSettings), poolInfo, Optional.ToList(metadata));
        }
    }
}
