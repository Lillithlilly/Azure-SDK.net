...
namespace Azure.Batch.Models
{
    ...
    public partial class CloudJobSchedule
    {
        ...
        internal CloudJobSchedule(string id, string displayName, string url, string eTag, DateTimeOffset? lastModified, DateTimeOffset? creationTime, JobScheduleState? state, DateTimeOffset? stateTransitionTime, JobScheduleState? previousState, DateTimeOffset? previousStateTransitionTime, Schedule schedule, JobSpecification jobSpecification, JobScheduleExecutionInformation executionInfo, IReadOnlyList<MetadataItem> metadata, JobScheduleStatistics stats)
        {
            Id = id;
