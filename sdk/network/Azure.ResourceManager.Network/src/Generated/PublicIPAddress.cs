...
namespace Azure.ResourceManager.Network
{
    ...
    public partial class PublicIPAddress : ArmResource
    {
        ...
        {
            using var scope = _publicIPAddressClientDiagnostics.CreateScope("PublicIPAddress.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _publicIPAddressClientDiagnostics.CreateScope("PublicIPAddress.Delete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<PublicIPAddress>> UpdateAsync(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _publicIPAddressClientDiagnostics.CreateScope("PublicIPAddress.Update");
            scope.Start();
            try
            {
                var response = await _publicIPAddressRestClient.UpdateTagsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new PublicIPAddress(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<PublicIPAddress> Update(TagsObject parameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _publicIPAddressRestClient.UpdateTags(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, parameters, cancellationToken);
                return Response.FromValue(new PublicIPAddress(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
