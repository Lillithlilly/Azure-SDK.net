...
namespace Microsoft.Azure.WebJobs.Extensions.EventGrid
{
    ...
    {
        internal static async Task<HttpResponseMessage> ProcessAsync(HttpRequestMessage req, string functionName, ILogger logger, Func<JArray, string, CancellationToken, Task<HttpResponseMessage>> eventsFunc, CancellationToken cancellationToken)
        {
            ...
            if (String.Equals(eventTypeHeader, "SubscriptionValidation", StringComparison.OrdinalIgnoreCase))
            {
                ...
                logger.LogInformation($"perform handshake with eventGrid for function: {functionName}");
