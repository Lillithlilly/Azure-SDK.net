...
namespace Azure.Communication.Router.Models
{
    ...
    {
        internal static Queue DeserializeQueue(JsonElement element)
        {
            ...
            return new Queue(id.Value, name.Value, distributionPolicyId.Value, Optional.ToDictionary(labels), exceptionPolicyId.Value);
        }
    }
}
