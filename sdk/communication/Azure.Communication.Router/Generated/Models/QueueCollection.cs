...
namespace Azure.Communication.Router.Models
{
    ...
    public partial class QueueCollection
    {
        ...
        internal QueueCollection(IEnumerable<Queue> value)
        {
            if (value == null)
            {
        ...
        internal QueueCollection(IReadOnlyList<Queue> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<Queue> Value { get; }
