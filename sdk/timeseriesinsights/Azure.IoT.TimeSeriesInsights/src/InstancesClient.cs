...
namespace Azure.IoT.TimeSeriesInsights
{
    ...
    public class InstancesClient
    {
        ...
        internal InstancesClient(TimeSeriesInstancesRestClient timeSeriesInstancesRestClient, ClientDiagnostics clientDiagnostics)
        {
            Argument.AssertNotNull(timeSeriesInstancesRestClient, nameof(timeSeriesInstancesRestClient));
            Argument.AssertNotNull(clientDiagnostics, nameof(clientDiagnostics));

            _timeSeriesInstancesRestClient = timeSeriesInstancesRestClient;
        ...
        public virtual Pageable<TimeSeriesInstance> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                Page<TimeSeriesInstance> FirstPageFunc(int? pageSizeHint)
                {
                    ...
                    try
                    {
                        Response<GetInstancesPage> getInstancesResponse = _timeSeriesInstancesRestClient.List(null, null, cancellationToken);
                        return Page.FromValues(getInstancesResponse.Value.Instances, getInstancesResponse.Value.ContinuationToken, getInstancesResponse.GetRawResponse());
                    }
                    catch (Exception ex)
                    {
                ...
                Page<TimeSeriesInstance> NextPageFunc(string nextLink, int? pageSizeHint)
                {
                    ...
                    try
                    {
                        Response<GetInstancesPage> getInstancesResponse = _timeSeriesInstancesRestClient.List(nextLink, null, cancellationToken);
                        return Page.FromValues(getInstancesResponse.Value.Instances, getInstancesResponse.Value.ContinuationToken, getInstancesResponse.GetRawResponse());
                    }
                    catch (Exception ex)
                    {
