...
namespace Azure.ResourceManager.AppService
{
    ...
    public static partial class ResourceGroupExtensions
    {
        ...
        /// <summary> Gets an object representing a AppServiceCertificateAutoGeneratedCollection along with the instance operations that can be performed on it. </summary>
        /// <param name="resourceGroup"> The <see cref="ResourceGroup" /> instance the method will execute against. </param>
        /// <returns> Returns a <see cref="AppServiceCertificateAutoGeneratedCollection" /> object. </returns>
        public static AppServiceCertificateAutoGeneratedCollection GetAppServiceCertificateAutoGenerateds(this ResourceGroup resourceGroup)
        {
            return new AppServiceCertificateAutoGeneratedCollection(resourceGroup);
        }
        #endregion
