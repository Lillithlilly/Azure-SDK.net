...
namespace Azure.ResourceManager.AppService
{
    ...
    public static partial class ArmClientExtensions
    {
        ...
        #region AppServiceCertificateAutoGenerated
        /// <summary> Gets an object representing a AppServiceCertificateAutoGenerated along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="armClient"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        /// <returns> Returns a <see cref="AppServiceCertificateAutoGenerated" /> object. </returns>
        public static AppServiceCertificateAutoGenerated GetAppServiceCertificateAutoGenerated(this ArmClient armClient, ResourceIdentifier id)
        {
            return armClient.UseClientContext((uri, credential, clientOptions, pipeline) => new AppServiceCertificateAutoGenerated(clientOptions, credential, uri, pipeline, id));
        }
        #endregion
