...
{
    /// <summary> A Class representing a AppServiceCertificateAutoGenerated along with the instance operations that can be performed on it. </summary>
    public partial class AppServiceCertificateAutoGenerated : ArmResource
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly CertificatesRestOperations _certificatesRestClient;
        private readonly AppServiceCertificateAutoGeneratedData _data;

        /// <summary> Initializes a new instance of the <see cref="AppServiceCertificateAutoGenerated"/> class for mocking. </summary>
        protected AppServiceCertificateAutoGenerated()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "AppServiceCertificateAutoGenerated"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="resource"> The resource that is the target of operations. </param>
        internal AppServiceCertificateAutoGenerated(ArmResource options, AppServiceCertificateAutoGeneratedData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal AppServiceCertificateAutoGenerated(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _certificatesRestClient = new CertificatesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
        }
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AppServiceCertificateAutoGenerated(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _certificatesRestClient = new CertificatesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
        }
        ...
        public virtual AppServiceCertificateAutoGeneratedData Data
        {
            get
            {
                if (!HasData)
        ...
        public async virtual Task<Response<AppServiceCertificateAutoGenerated>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateAutoGenerated.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new AppServiceCertificateAutoGenerated(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Description for Get a certificate. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<AppServiceCertificateAutoGenerated> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateAutoGenerated.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateAutoGenerated.Delete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<AppServiceCertificateAutoGenerated>> UpdateAsync(CertificatePatchResource certificateEnvelope, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("AppServiceCertificateAutoGenerated.Update");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="certificateEnvelope"/> is null. </exception>
        public virtual Response<AppServiceCertificateAutoGenerated> Update(CertificatePatchResource certificateEnvelope, CancellationToken cancellationToken = default)
        {
            if (certificateEnvelope == null)
            {
                throw new ArgumentNullException(nameof(certificateEnvelope));
