...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class NetworkFeaturesData : ProxyOnlyResource
    {
        ...
        internal NetworkFeaturesData(ResourceIdentifier id, string name, ResourceType type, string kind, string virtualNetworkName, VnetInfoAutoGenerated virtualNetworkConnection, IReadOnlyList<RelayServiceConnectionEntityData> hybridConnections, IReadOnlyList<HybridConnectionData> hybridConnectionsV2) : base(id, name, type, kind)
        {
        ...
        public VnetInfoAutoGenerated VirtualNetworkConnection { get; }
