...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class AppServiceDetectorData : ProxyOnlyResource
    {
        ...
        internal AppServiceDetectorData(ResourceIdentifier id, string name, ResourceType type, string kind, DetectorInfo metadata, IList<DiagnosticData> dataset, IdentifyInsightStatus status, IList<DataProviderMetadata> dataProvidersMetadata, QueryUtterancesResults suggestedUtterances) : base(id, name, type, kind)
        {
            Metadata = metadata;
            Dataset = dataset;
            Status = status;
        ...
        public IdentifyInsightStatus Status { get; set; }
