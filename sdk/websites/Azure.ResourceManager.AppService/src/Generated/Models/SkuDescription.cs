...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class SkuDescription
    {
        ...
        internal SkuDescription(string name, string tier, string size, string family, int? capacity, SkuCapacity skuCapacity, IList<string> locations, IList<SKUCapability> capabilities)
        {
            Name = name;
            Tier = tier;
            Size = size;
