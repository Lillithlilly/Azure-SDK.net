...
namespace Azure.ResourceManager.AppService
{
    public partial class NetworkFeaturesData : IUtf8JsonSerializable
    {
        ...
        internal static NetworkFeaturesData DeserializeNetworkFeaturesData(JsonElement element)
        {
            ...
            Optional<VnetInfoAutoGenerated> virtualNetworkConnection = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("virtualNetworkConnection"))
                        {
                            ...
                            virtualNetworkConnection = VnetInfoAutoGenerated.DeserializeVnetInfoAutoGenerated(property0.Value);
                            continue;
                        }
            ...
            return new NetworkFeaturesData(id, name, type, kind.Value, virtualNetworkName.Value, virtualNetworkConnection.Value, Optional.ToList(hybridConnections), Optional.ToList(hybridConnectionsV2));
        }
    }
}
