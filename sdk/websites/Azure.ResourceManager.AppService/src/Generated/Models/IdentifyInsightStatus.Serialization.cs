...
{
    public partial class IdentifyInsightStatus : IUtf8JsonSerializable
    {
        ...
        internal static IdentifyInsightStatus DeserializeIdentifyInsightStatus(JsonElement element)
        {
            ...
            return new IdentifyInsightStatus(message.Value, Optional.ToNullable(statusId));
        }
    }
}
