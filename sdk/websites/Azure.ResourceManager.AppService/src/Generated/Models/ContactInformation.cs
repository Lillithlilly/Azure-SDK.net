...
namespace Azure.ResourceManager.AppService.Models
{
    ...
    public partial class ContactInformation
    {
        ...
        /// <param name="phone"> Phone number. </param>
        internal ContactInformation(RegistrationAddress addressMailing, string email, string fax, string jobTitle, string nameFirst, string nameLast, string nameMiddle, string organization, string phone)
        {
        ...
        public RegistrationAddress AddressMailing { get; set; }
