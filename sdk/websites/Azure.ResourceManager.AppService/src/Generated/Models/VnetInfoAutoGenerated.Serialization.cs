...
{
    public partial class VnetInfoAutoGenerated
    {
        internal static VnetInfoAutoGenerated DeserializeVnetInfoAutoGenerated(JsonElement element)
        {
            ...
            return new VnetInfoAutoGenerated(vnetResourceId.Value, certThumbprint.Value, certBlob.Value, Optional.ToList(routes), Optional.ToNullable(resyncRequired), dnsServers.Value, Optional.ToNullable(isSwift));
        }
    }
}
