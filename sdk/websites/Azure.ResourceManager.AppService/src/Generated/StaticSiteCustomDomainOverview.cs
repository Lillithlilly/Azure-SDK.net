...
{
    /// <summary> A Class representing a StaticSiteCustomDomainOverview along with the instance operations that can be performed on it. </summary>
    public partial class StaticSiteCustomDomainOverview : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="StaticSiteCustomDomainOverview"/> class for mocking. </summary>
        protected StaticSiteCustomDomainOverview()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "StaticSiteCustomDomainOverview"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="resource"> The resource that is the target of operations. </param>
        internal StaticSiteCustomDomainOverview(ArmResource options, StaticSiteCustomDomainOverviewData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal StaticSiteCustomDomainOverview(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _staticSitesRestClient = new StaticSitesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
        }
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal StaticSiteCustomDomainOverview(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _staticSitesRestClient = new StaticSitesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
        }
        ...
        public async virtual Task<Response<StaticSiteCustomDomainOverview>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("StaticSiteCustomDomainOverview.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new StaticSiteCustomDomainOverview(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Description for Gets an existing custom domain for a particular static site. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<StaticSiteCustomDomainOverview> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("StaticSiteCustomDomainOverview.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("StaticSiteCustomDomainOverview.Delete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<StaticSiteValidateCustomDomainCanBeAddedToStaticSiteOperation> ValidateCustomDomainCanBeAddedToStaticSiteAsync(StaticSiteCustomDomainRequestPropertiesARMResource staticSiteCustomDomainRequestPropertiesEnvelope, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("StaticSiteCustomDomainOverview.ValidateCustomDomainCanBeAddedToStaticSite");
            scope.Start();
            try
            {
