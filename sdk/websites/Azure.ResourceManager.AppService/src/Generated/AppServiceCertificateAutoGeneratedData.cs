...
{
    /// <summary> A class representing the AppServiceCertificateAutoGenerated data model. </summary>
    public partial class AppServiceCertificateAutoGeneratedData : AppServiceResource
    {
        /// <summary> Initializes a new instance of AppServiceCertificateAutoGeneratedData. </summary>
        /// <param name="location"> The location. </param>
        public AppServiceCertificateAutoGeneratedData(Location location) : base(location)
        {
