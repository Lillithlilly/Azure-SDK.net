...
namespace Azure.ResourceManager.AppService
{
    ...
    public partial class SiteVirtualNetworkConnection : ArmResource
    {
        ...
        internal SiteVirtualNetworkConnection(ArmResource options, VnetInfoData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<Response<SiteVirtualNetworkConnection>> UpdateAsync(VnetInfoData connectionEnvelope, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="connectionEnvelope"/> is null. </exception>
        public virtual Response<SiteVirtualNetworkConnection> Update(VnetInfoData connectionEnvelope, CancellationToken cancellationToken = default)
        {
            if (connectionEnvelope == null)
            {
                throw new ArgumentNullException(nameof(connectionEnvelope));
