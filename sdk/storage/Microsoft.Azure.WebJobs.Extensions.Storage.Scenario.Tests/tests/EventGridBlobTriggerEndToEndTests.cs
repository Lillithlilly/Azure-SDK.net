...
namespace Microsoft.Azure.WebJobs.Extensions.Storage.ScenarioTests
{
 ...
 @"[{
  ...
  ""topic"": ""/subscriptions/18318512-69ef-49db-9cbb-4a13fe0fa72c/resourceGroups/EventGrid/providers/Microsoft.Storage/StorageAccounts/alrodegtest"",
  ""subject"": """",
  ""data"": {
    ""validationCode"": ""F83B17BA-898A-4309-8F89-8BB2B3A06D02"",
    ""validationUrl"": ""https://rp-eastus.eventgrid.azure.net:553/eventsubscriptions/eg1/validate?id=F83B17BA-898A-4309-8F89-8BB2B3A06D02&t=2020-12-08T02:28:30.6463986Z&apiVersion=2020-04-01-preview&token=AEvNcDi9Gonj83RQEK4owr6zXA31QPzppkc7BwlvBeI%3d""
  },
...
@"[{
    ...
    ""contentLength"":1,
    ""blobType"":""BlockBlob"",
    ""url"":""https://alrodegtest.blob.core.windows.net/[blobPathPlaceHolder]"",
    ...
    ""eventTime"":""2020-12-15T02:41:51.9623179Z""
        ...
        public async Task PageBlob_NotSupported()
        {
            ...
            using (host)
            {
                ...
                var log = host.GetTestLoggerProvider().GetAllLogMessages()
                    .FirstOrDefault(x => x.Level == Microsoft.Extensions.Logging.LogLevel.Error && x.FormattedMessage == "PageBlobClient is not supported with BlobTriggerKind.EventGrid");
        ...
        public class EventGrid_Program
        {
            ...
            public void EventGridBlobTrigger(
                [BlobTrigger(EventGridContainerName + "/{name}", Kind = BlobTriggerKind.EventGrid)] string input)
            {
                _completedEvent.Set();
            }
        }
        ...
        public class EventGrid_PageBlob
        {
            [FunctionName("EventGridBlobTrigger")]
            public void EventGridBlobTrigger(
                [BlobTrigger(EventGridContainerName + "/{name}", Kind = BlobTriggerKind.EventGrid)] PageBlobClient input)
            {
            }
        }
    }
